...
def amc_view(request, pk):
    ...
    con = sqlite3.connect("/examreview/amc_projects/2024/1/CS-119h_final/data/capture.sqlite")
    cur = con.cursor()
    ...
    con = sqlite3.connect("/examreview/amc_projects/2024/1/CS-119h_final/data/layout.sqlite")
    cur = con.cursor()
