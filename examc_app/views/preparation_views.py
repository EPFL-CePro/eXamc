...
from examc_app.forms import CreateExamProjectForm, SummernoteForm, PrepSectionForm, \
    PrepQuestionForm, PrepQuestionAnswerForm, ExamFirstPageForm, CreatePrepQuestionForm
...
def exam_preparation_view(request, exam_pk):
    ...
    for section in sections:
        ...
        for question in section.questions:
            ...
            question.answers = []
            if question.question_type and question.question_type.code in ["SCQ", "MCQ", "TF"]:
