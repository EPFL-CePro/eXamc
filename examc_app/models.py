...
class PageMarkers(models.Model):
    ...
    pages_group = models.ForeignKey(PagesGroup, on_delete=models.CASCADE, related_name='pageMarkers', blank=True, null=True)
...
class Scale(models.Model):
    ...
    def __str__(self):
        if self.exam:
            return self.name + "(" + str(self.total_points) + ", " + str(self.points_to_add) + ", " + self.formula + ", " + str(self.final) + ")" + self.exam.code + " - " + self.exam.name + " " + self.exam.year + " " + str(self.exam.semester)
        else:
            return self.name + "(" + str(self.total_points) + ", " + str(self.points_to_add) + ", " + self.formula + ", " + str(self.final) + ") NO EXAM !"
